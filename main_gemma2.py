...
from data_gemma2 import data_process
from inference_gemma2 import keyphrases_selection
...
#         device_map="auto",
    ...
    keyphrases_selection(setting_dict, doc_list, labels_stemed, labels, dataloader, std_scaling,att_weight, model2, device)
